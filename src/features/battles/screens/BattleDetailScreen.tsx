...
import { getResultByEventId } from '@/features/sports/api';
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.battleCard}>
          ...
          {battle.description && <Text style={styles.battleDescription}>{battle.description}</Text>}
        ...
        {battle.status === 'completed' && (
          <View style={styles.winnerCard}>
            ...
            <Text style={styles.winnerName}>Winner: {getWinnerName(battle.winner_id)}</Text>
          ...
          <View style={styles.joinSection}>
            ...
            <View style={styles.joinCard}>
              {isHeadToHeadReady ? (
                <>
                  ...
                  <View style={styles.challengeInfo}>
                    ...
                    <View style={[styles.predictionBox, styles.yourPredictionBox]}>
                      ...
                      <Text style={[styles.predictionTeam, styles.yourPredictionTeam]}>
                ...
                <Text style={styles.loadingPickText}>
