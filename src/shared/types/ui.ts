...
export interface BattleTypeScreenProps {
  navigation: any;
}

export interface StatDuelModeScreenProps {
  navigation: any;
  route: any;
}

export interface StatDuelDetailsScreenProps {
  navigation: any;
  route: any;
}

export interface StatDuelConfirmScreenProps {
  navigation: any;
  route: any;
}

export interface StatDuelOpponentScreenProps {
  navigation: any;
  route: any;
}

export interface StatDuelChampionScreenProps {
  navigation: any;
  route: any;
}

export interface CreateBattleScreenProps {
  navigation: any;
  route: any;
}

export interface StartBattleScreenProps {
  navigation: any;
}

export interface BattleVisibilityScreenProps {
  navigation: any;
  route: any;
}

export interface BattleDetailScreenProps {
  navigation: any;
  route: any;
}

export interface AllResultsScreenProps {
  navigation: any;
  route?: any;
}

export interface AllUpcomingGamesScreenProps {
  navigation: any;
  route: any;
}
...
export interface CreateUsernameScreenProps {
  navigation: { goBack: () => void; navigate: (screen: string) => void };
}
